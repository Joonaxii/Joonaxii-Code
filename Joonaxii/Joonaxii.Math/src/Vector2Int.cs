...
namespace Joonaxii.MathJX
{
    ...
    public struct Vector2Int : IEquatable<Vector2Int>
    {
        ...
        public static Vector2Int operator /(Vector2Int vector1, int divider) =>
         new Vector2Int(vector1.x / divider, vector1.y / divider);

        public static Vector2Int operator *(Vector2Int vector1, int scalar) =>
         new Vector2Int(vector1.x * scalar, vector1.y * scalar);
